...
export class TransactionService {
  ...
  getWebinarTransactions(params: any): Promise<any> {
    return this.restangular.one('payment/webinar-transactions').get(params).toPromise();
  }
  sendReceipt(params: any) {
    return this.restangular.all('payment/transactions/send-receipt').post(params).toPromise();
  }
