...
import { AuthService, CourseService, SeoService, UtilService } from '../shared/services';
import { CategoryService, TopicService, TestimonialService } from '../shared/services';
...
export class StarterComponent implements OnInit, AfterViewInit {
  ...
  async ngOnInit() {
    ...
    if (this.config) {
      await this.seoService.update(this.config.siteName, this.config.homeSEO);
    }
    ...
    const params = Object.assign(
      {
        ...
        take: this.pageSize,
        sort: `${this.sortOptionWebinar.sortBy}`,
        sortType: `${this.sortOptionWebinar.sortType}`,
        isOpen: true,
