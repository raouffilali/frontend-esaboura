import { Component, Input, AfterContentInit, AfterViewInit, OnInit } from '@angular/core';
...
export class UserLeftMenuComponent implements OnInit, AfterViewInit {
  public type: any = '';
      ...
      $(document).ready(function () {
        ...
        pnAdvancerLeft.addEventListener('click', function () {
          ...
          if (
            ...
            const navBarLeftEdge = pnProductNavContents.getBoundingClientRect().left;
            const navBarScrollerLeftEdge = pnProductNav.getBoundingClientRect().left;
            // Now we know how much space we have available to scroll
            const availableScrollLeft = Math.floor(navBarScrollerLeftEdge - navBarLeftEdge);
