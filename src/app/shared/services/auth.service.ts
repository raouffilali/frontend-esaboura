...
export class AuthService {
  ...
  constructor(private restangular: Restangular, private appService: AppService) {}
  ...
  login(credentials: any): Promise<any> {
    return this.restangular
      ...
      .then(resp => {
        ...
        Cookies.set('isLoggedin', 'yes', { domain: this.appService.settings.zoomDomain });
        Cookies.set('accessToken', resp.data.token, { domain: this.appService.settings.zoomDomain });
        return this.restangular
          .one('users', 'me')
          .get()
          .toPromise()
